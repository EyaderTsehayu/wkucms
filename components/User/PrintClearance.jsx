...
export default function RequestClearance() {
    return (
        <div style={{ width: "100%", height: "70%" }} className="border border-bodydark1 flex justify-center align-middle mt-7 bg-white dark:bg-boxdark text-black dark:text-white p-10 rounded-lg shadow-md">
            <p>
