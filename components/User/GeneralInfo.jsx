...
const GeneralInfo = () => {
    ...
    const [accordionOpen, setAccordionOpen] = useState(Array(filteredInfo.length).fill(false));
    ...
    return (
        <div className="">
            ...
            />
            <div className="mt-6 grid grid-cols-1 gap-4 md:gap-6 xl:grid-cols-2 xl:gap-7.5">
