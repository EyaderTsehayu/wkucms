...
const Breadcrumb = (props) => {
  return (
    <div class="pt-6 pb-1  px-4">
      <div className="mt-2 py-2.5 px-4 bg-gray-2 dark:bg-meta-4 flex flex-col gap-3 rounded-md  sm:flex-row sm:items-center sm:justify-between">
